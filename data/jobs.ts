...
export const jobs: WorkExperience[] = [
  {
    ...
    companyDescription:
      "Devon is a Fortune 500 company leading oil & gas exploration and production in the US, and previously in Canada.",
  ...
  },
  {
    ...
    companyDescription:
      "Morgan Stanley is a leading global financial services firm. I worked in the equity management software divison, Morgan Stanley at Work.",
    contributions: [
  ...
  },
  {
    ...
    companyDescription:
      "Vybes is an AI-driven social network connecting Gen Z through shared interests with $170,000 in startup funding from investors.",
    company: "Vybes",
    contributions: [
